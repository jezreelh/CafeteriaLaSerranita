...
<body>
                    ...
                    <div class="main-menu-wrap">
                        ...
                        <nav class="main-menu">
                            <ul>
                                ...
                                <li  class="current-list-item"><a href="order.php">Cómo Comprar</a></li>
	...
	<div class="container">
        <h2 class="my-4 text-center">Pasos para realizar un pedido en La Serranita</h2>
        <div class="step-box">
            <div class="step-icon">
            ...
            <div class="content">
                ...
                <p>Accede al sitio web de La Serranita.</p>
            </div>
        </div>
        <div class="step-box">
            <div class="step-icon">
            ...
            <div class="content">
                ...
                <p>Dirígete a la sección del menú y selecciona los productos que deseas.</p>
            </div>
        </div>
        <div class="step-box">
            <div class="step-icon">
            ...
            <div class="content">
                ...
                <p>Una vez seleccionados, procede al carrito de compras.</p>
            </div>
        </div>
        <div class="step-box">
            <div class="step-icon">
            ...
            <div class="content">
                ...
                <p>Verifica que tu pedido esté correcto.</p>
            </div>
        </div>
        <div class="step-box">
            <div class="step-icon">
            ...
            <div class="content">
                <h3>Especifica detalles</h3>
                <p>En la sección de notas, especifica cómo deseas que se preparen tus productos y a nombre de quién será el pedido.</p>
            </div>
        </div>
        <div class="step-box">
            <div class="step-icon">
            ...
            <div class="content">
                ...
                <p>Dirígete al edificio F para recoger tu pedido.</p>
            </div>
        </div>
        <div class="step-box">
            <div class="step-icon">
                <div class="circle-icon">7</div>
            </div>
            <div class="content">
                <h3>Realiza el pago</h3>
                <p>Realiza el pago en la caja del edificio F.</p>
            </div>
        </div>
        <h2 class="my-4 text-center">Restricciones y advertencias</h2>
        <div class="alert-box">
            <div class="alert-icon">
                <i class="fas fa-exclamation-circle"></i>
            </div>
            <div class="content">
                <p class="p-order">Los pedidos realizados en línea no deben exceder los $150.</p>
            </div>
        </div>
        <div class="alert-box">
            <div class="alert-icon">
            ...
            <div class="content">
                <p class="p-order">Las instrucciones de preparación deben ser claras y específicas.</p>
            </div>
        </div>
    </div>
